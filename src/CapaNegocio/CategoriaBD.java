...
public class CategoriaBD {
    ...
    public List<Categoria> reportarCategoria() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Error al reportar categorias BD...", JOptionPane.ERROR_MESSAGE);
    ...
    public List<Categoria> buscarCategorias(String valor) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Error al buscar categoriasBD...", JOptionPane.ERROR_MESSAGE);
            return null;
        }
        return lista;
    }
